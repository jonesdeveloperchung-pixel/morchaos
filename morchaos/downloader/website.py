...
def crawl_website(start_url: str, max_depth: int = 2, max_pages: int = 100) -> List[str]:
...
def download_website(url: str, dest: Union[str, Path], 
                    include_assets: bool = False) -> bool:
