...
def download_images_from_page(url: str, dest: Union[str, Path], 
                            filter_size: bool = True) -> List[str]:
...
def search_and_download_images(query: str, dest: Union[str, Path], 
                             max_images: int = 20) -> List[str]:
