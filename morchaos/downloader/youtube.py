...
def download_video(url: str, dest: Union[str, Path] = "./downloads", 
                  format_selector: str = "best", audio_only: bool = False) -> bool:
    ...
    args = [
        downloader,
        '--output', str(dest / '%(title)s.%(ext)s'),
        '--format', 'bestaudio' if audio_only else format_selector,
        url
    ]
...
def download_playlist(url: str, dest: Union[str, Path] = "./downloads",
                     format_selector: str = "best") -> bool:
    ...
    args = [
        downloader,
        '--output', str(dest / '%(playlist_index)s - %(title)s.%(ext)s'),
