...
class SMTPClient:
    ...
    def __init__(self, server: str, port: int = 587, username: str = "", 
...
def send_simple_email(smtp_server: str, username: str, password: str,
...
def send_gmail(username: str, password: str, to_address: str, 
              subject: str, body: str) -> bool:
    """Send email via Gmail SMTP."""
    return send_simple_email('smtp.gmail.com', username, password,
